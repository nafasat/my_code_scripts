...
def find_captain_room(numbers, input_list):
    index = 0
    for e in range(int(len(input_list)/numbers)):
        if input_list.count(input_list[index]) == numbers:
            remove_element = input_list[index]
            for _ in range(5):
